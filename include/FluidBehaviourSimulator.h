#ifndef FluidBehaviourSimulatorHEADER
#define FluidBehaviourSimulatorHEADER
...
class Simulation {
    ...
    std::array<std::array<Fixed, m>, n> p;
    std::array<std::array<Fixed, m>, n> old_p;
    ...
    std::array<std::array<int, m>, n> last_use;
    int UT = 0;
    ...
    Fixed random01() {
        return Fixed::from_raw((rnd() & ((1 << k) - 1)));
    }
    ...
    std::array<std::array<int, m>, n> dirs = {};

    friend class Fixed;
    private:
    constexpr Field m_field;
    int n, m;
    mt19937 rnd(1337);
    constexpr std::array<std::pair<int, int>, 4> deltas{{{-1, 0}, {1, 0}, {0, -1}, {0, 1}}};
};

#endif // FluidBehaviourSimulatorHEADER